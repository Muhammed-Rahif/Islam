  ...
  plugins: [
    ...
    [
      '@semantic-release/exec',
      {
        ...
        successCmd:
          'yarn tsx scripts/telegram-bot/success-release.ts --versionName ${nextRelease.gitTag} --releaseType ${nextRelease.type} --branchName ${branch.name} --releaseNotes "${nextRelease.notes}"',
      },
    ],
    [
